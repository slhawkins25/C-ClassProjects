        ...
        static void doWork()
        {
            try
            {
               ...
               a.printString("Hello from ClassA  \n");
                ...
                Console.WriteLine("Analyzing ClassF type variable:");
                Console.WriteLine($"{theChecker.check(f)}");
                f.howdy("");

                Console.WriteLine("Analyzing ClassG type variable:");
                Console.WriteLine($"{theChecker.check(g)}");
                g.howdy("");
